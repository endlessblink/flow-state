...
function registerUpdater() {
    ...
    electron_updater_1.autoUpdater.on('update-available', (info) => {
        const failure = (0, updater_pending_1.readPendingUpdateFailure)();
        const blockedVersion = failure?.version ?? (0, updater_pending_1.pendingUpdateFailureVersion)();
        if (failure &&
            blockedVersion &&
            (0, updater_pending_1.compareVersions)(blockedVersion, appVersion) > 0 &&
            blockedVersion === info.version &&
            (0, updater_pending_1.shouldSuppressAutomaticRetry)(failure)) {
