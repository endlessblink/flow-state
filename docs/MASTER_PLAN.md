...
| **BUG-1045**             | **Canvas Loads Empty, Populates Only After Restart**                     | **P2**                                              | 👀 **REVIEW**                                                                                                                   | Web app canvas loads empty initially - tasks only appear after page restart. Root cause: canvas auto-init before auth ready. Fix: removed auto-init (same as BUG-339).                                                           | BUG-339                                                |
...
| ~~**BUG-1051**~~         | ✅ **DONE** **CRITICAL: Date Changes Reset After Refresh (Quick Sort/Inbox)** | **P0**                                              | ✅ **DONE** (2026-01-24)                                                                                                         | Fixed: Comprehensive persistence audit found 73+ fire-and-forget async calls, 8 unmapped Supabase fields, 7 unpersisted UI states, 4 sync race conditions, and 8 silent error swallowing functions. All fixed with await, useStorage, re-throw. | TASK-1010, BUG-1046                                    |
...
### BUG-1045: Canvas Loads Empty, Populates Only After Restart (👀 REVIEW)
