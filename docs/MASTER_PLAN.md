...
| **BUG-1044**             | **Quick Sort Changes Reset/Reverted**                                    | **P0**                                              | 🔄 **IN PROGRESS**                                                                                                              | Quick Sort UI/functionality changes appear to have been reset or reverted. Need to investigate what happened and restore the changes.                                                                                          | TASK-1010                                              |
