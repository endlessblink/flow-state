...
| **BUG-1067**             | **Tauri: Canvas Selection Rectangle Offset from Cursor**                | **P2**                                              | 🔄 **IN PROGRESS**                                                                                                              | Tauri-specific: Selection preview box when drag-selecting appears in wrong position relative to cursor/mouse position                                                                                              |                                                        |
...
| **BUG-1069**             | **Cloudflare Cache Serving Stale Data (Brave/Zen)**                      | **P2**                                              | 🔄 **IN PROGRESS**                                                                                                              | Chromium browsers showing cached data despite BUG-1063 fix. Missing `no-cache` on index.html causes stale HTML with old asset references. [SOP-032](./sop/SOP-032-cloudflare-cache-mime-prevention.md)              | BUG-1063                                               |
