...
| **BUG-1095**             | **Calendar: No Time Indicator + Icon/Element Overlap**                   | **P2**                                              | 📋 **PLANNED**                                                                                                                  | Calendar view issues: (1) No start/end time shown on events, (2) Unrelated icon appearing on task cards, (3) Elements overlapping in narrow slots. Affects task readability.                                             | BUG-1055                                               |
