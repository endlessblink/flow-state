...
```bash
curl -X PUT http://REDACTED_CREDENTIALS@84.46.253.137:5984/_node/_local/_config/httpd/enable_cors -d '"true"'
curl -X PUT http://REDACTED_CREDENTIALS@84.46.253.137:5984/_node/_local/_config/cors/origins -d '"*"'
curl -X PUT http://REDACTED_CREDENTIALS@84.46.253.137:5984/_node/_local/_config/cors/credentials -d '"true"'
curl -X PUT http://REDACTED_CREDENTIALS@84.46.253.137:5984/_node/_local/_config/cors/methods -d '"GET, PUT, POST, HEAD, DELETE"'
curl -X PUT http://REDACTED_CREDENTIALS@84.46.253.137:5984/_node/_local/_config/cors/headers -d '"accept, authorization, content-type, origin, referer"'
```
...
2. **Reset remote CouchDB** to clear corrupted data:
   ```bash
   curl -X DELETE http://REDACTED_CREDENTIALS@84.46.253.137:5984/pomoflow-tasks
   curl -X PUT http://REDACTED_CREDENTIALS@84.46.253.137:5984/pomoflow-tasks
   ```
