...
**Follow-up release proof**: Electron 1.4.270 passed the full 3,917-test ship gate, Electron sync guard, type checks, package validation, and independent release-blocker review. The production updater manifest serves 1.4.270; both AppImage and deb respond to range requests with byte sizes matching the manifest.
