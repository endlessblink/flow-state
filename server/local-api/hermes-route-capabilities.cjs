...
const HERMES_ROUTE_CAPABILITIES = Object.freeze([
  ...
  { method: 'POST', path: '/api/timer/lifecycle', contractVersion: 'timer-lifecycle-v1', available: true },
  { method: 'GET', path: '/api/tasks/:id/instances', contractVersion: 'task-instances-v1', available: true },
  { method: 'GET', path: '/api/tasks/:id/recurrence-chain', contractVersion: 'recurrence-chain-v1', available: true },
  { method: 'POST', path: '/api/tasks/:id/recurrence-lifecycle', contractVersion: 'recurrence-lifecycle-v1', available: true },
