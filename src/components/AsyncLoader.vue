  ...
  <div class="async-loader" :class="loaderClasses">
    ...
    <div v-if="status.loading" class="loading-state">
      ...
      <div class="loading-content">
        <h4 v-if="title" class="loading-title">{{ title }}</h4>
    ...
    <div v-else-if="status.error && showError" class="error-state">
      ...
      <div class="error-content">
        ...
        <div class="error-actions">
          <button v-if="showRetry" @click="retry" class="btn btn-primary btn-sm" :disabled="status.loading">
          ...
          <button v-if="showFallback" @click="useFallback" class="btn btn-secondary btn-sm">
            Use Fallback
          </button>
        </div>
      </div>
