        ...
        >
          ...
          <div class="layout-section">
            ...
            <div class="layout-icon-row">
              <button class="menu-item menu-item-icon" title="Align Left" aria-label="Align Left" @click="handleAlignLeft">
                <AlignHorizontalJustifyStart :size="16" :stroke-width="1.5" />
              </button>
              <button class="menu-item menu-item-icon" title="Center Horizontally" aria-label="Center Horizontally" @click="handleAlignCenterHorizontal">
                <AlignHorizontalJustifyCenter :size="16" :stroke-width="1.5" />
              </button>
              <button class="menu-item menu-item-icon" title="Align Right" aria-label="Align Right" @click="handleAlignRight">
                <AlignHorizontalJustifyEnd :size="16" :stroke-width="1.5" />
              </button>
            </div>
            <div class="layout-icon-row">
              <button class="menu-item menu-item-icon" title="Align Top" aria-label="Align Top" @click="handleAlignTop">
                <AlignVerticalJustifyStart :size="16" :stroke-width="1.5" />
              </button>
              <button class="menu-item menu-item-icon" title="Center Vertically" aria-label="Center Vertically" @click="handleAlignCenterVertical">
                <AlignVerticalJustifyCenter :size="16" :stroke-width="1.5" />
              </button>
              <button class="menu-item menu-item-icon" title="Align Bottom" aria-label="Align Bottom" @click="handleAlignBottom">
          ...
          <template v-if="selectedCount >= 3">
            ...
            <div class="layout-section">
              ...
              <div class="layout-icon-row">
                <button class="menu-item menu-item-icon-wide" title="Distribute Horizontally" aria-label="Distribute Horizontally" @click="handleDistributeHorizontal">
                  <ArrowLeftRight :size="16" :stroke-width="1.5" />
                  <span>Horiz</span>
                </button>
                <button class="menu-item menu-item-icon-wide" title="Distribute Vertically" aria-label="Distribute Vertically" @click="handleDistributeVertical">
          ...
          <div class="layout-section">
            ...
            <div class="layout-icon-row">
              <button class="menu-item menu-item-icon-wide" title="Arrange in Row" aria-label="Arrange in Row" @click="handleArrangeInRow">
                <Rows :size="16" :stroke-width="1.5" />
                <span>Row</span>
              </button>
              <button class="menu-item menu-item-icon-wide" title="Arrange in Column" aria-label="Arrange in Column" @click="handleArrangeInColumn">
                <LayoutList :size="16" :stroke-width="1.5" />
                <span>Column</span>
              </button>
              <button class="menu-item menu-item-icon-wide" title="Arrange in Grid" aria-label="Arrange in Grid" @click="handleArrangeInGrid">
