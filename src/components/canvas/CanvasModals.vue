<template>
  ...
  <UnifiedGroupModal
    ...
    @created="(group) => $emit('handleGroupCreated', group as unknown as Record<string, unknown>)"
    @updated="(group) => $emit('handleGroupUpdated', group as unknown as Record<string, unknown>)"
  />
  ...
  <GroupEditModal
    ...
    @save="(updatedSection) => $emit('handleGroupEditSave', updatedSection as unknown as Record<string, unknown>)"
  />
