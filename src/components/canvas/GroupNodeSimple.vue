...
const taskCount = computed(() => {
  ...
  const direct = typeof data.directTaskCount === 'number' ? data.directTaskCount : 0
  const aggregated = typeof data.aggregatedTaskCount === 'number' ? data.aggregatedTaskCount : direct
