    ...
    <div v-if="multiSelectMode" class="selection-controls">
      <div class="control-group">
        ...
        <button
          ...
          :title="mode.description" :aria-label="mode.description"
      ...
      <div class="control-group">
        ...
        <button class="action-btn" title="Select All" aria-label="Select All" @click="selectAll">
          <CheckSquare :size="14" />
        </button>
        <button class="action-btn" title="Clear Selection" aria-label="Clear Selection" @click="clearSelection">
          <X :size="14" />
        </button>
        <button class="action-btn" title="Invert Selection" aria-label="Invert Selection" @click="invertSelection">
          <RotateCcw :size="14" />
        </button>
      </div>
