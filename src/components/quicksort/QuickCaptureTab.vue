...
const titleAlignmentClasses = computed(() => getAlignmentClasses(newTask.title))
const titleAlignmentStyles = computed(() => applyInputAlignment(newTask.title))
const descriptionAlignmentClasses = computed(() => getAlignmentClasses(newTask.description || ''))
const descriptionAlignmentStyles = computed(() => applyInputAlignment(newTask.description || ''))
