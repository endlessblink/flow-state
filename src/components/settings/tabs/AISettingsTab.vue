...
function onWpProviderChange(provider: AIProviderKey) {
  settingsStore.updateSetting('weeklyPlanProvider' as any, provider)
  // Reset model when provider changes
  settingsStore.updateSetting('weeklyPlanModel' as any, '')
}

function onWpModelChange(event: Event) {
  const value = (event.target as HTMLSelectElement).value
  settingsStore.updateSetting('weeklyPlanModel' as any, value || '')
}
