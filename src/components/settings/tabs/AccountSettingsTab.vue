        ...
        <div v-if="showChangePassword" class="change-password-form">
          <div class="form-group">
            ...
            <div class="password-input-wrapper">
              ...
              >
              <button class="toggle-visibility" @click="showPassword = !showPassword" :aria-label="showPassword ? 'Hide password' : 'Show password'">
    ...
    <SettingsSection v-if="showLocalApi" title="Local Task API (Life OS)">
      ...
      <div v-if="localApiEnabled" class="local-api-token">
        ...
        <div class="password-input-wrapper">
          ...
          >
          <button class="toggle-visibility" :title="localApiCopied ? 'Copied!' : 'Copy'" @click="copyLocalApiToken" aria-label="Copy local API token">
