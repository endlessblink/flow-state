<template>
  <div>
    ...
    <div class="section-header">
      ...
      <button class="add-lane-btn" title="Add lane" aria-label="Add lane" @click="startCreate">
        <Plus :size="14" />
      </button>
    </div>
    ...
    <nav class="lanes-list" aria-label="Lanes">
      ...
      >
        ...
        <button class="lane-delete-btn" title="Delete lane" aria-label="Delete lane" @click.stop="askDelete(lane)">
          <Trash2 :size="13" />
        </button>
      </div>
    </nav>
