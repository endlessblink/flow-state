<template>
  <div>
    ...
    <div class="section-header">
      ...
      <button class="add-project-btn" :title="$t('sidebar.add_project')" :aria-label="$t('sidebar.add_project')" @click="sidebar.openCreateProject">
        <Plus :size="14" />
      </button>
    </div>
    ...
    <Transition name="fade">
      <div v-if="multiSelectMode" class="project-selection-bar">
        ...
        <button
          ...
          title="Delete selected projects" aria-label="Delete selected projects"
        ...
        <button
          ...
          title="Clear selection (Esc)" aria-label="Clear selection (Esc)"
