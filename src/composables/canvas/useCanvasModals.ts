...
export function useCanvasModals() {
    ...
    // Section Settings Modal (Aliases for compatibility)
    const isSectionSettingsOpen = isGroupEditModalOpen
    const editingSection = selectedSectionForEdit
    ...
    return {
        ...
        isSectionSettingsOpen, // Alias
        editingSection, // Alias
