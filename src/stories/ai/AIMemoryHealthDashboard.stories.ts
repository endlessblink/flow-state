...
const S = {
  ...
  progressBar: 'background:var(--glass-bg-soft);border:1px solid var(--border-primary);border-radius:var(--radius-lg);padding:12px 16px;backdrop-filter:blur(8px);margin-bottom:20px',
  progressInfo: 'display:flex;justify-content:space-between;margin-bottom:6px;font-size:12px;color:var(--text-secondary)',
  progressTrack: 'height:4px;background:var(--surface-secondary);border-radius:2px;overflow:hidden',
  progressFill: 'height:100%;background:var(--brand-primary);border-radius:2px',
  section: 'background:var(--glass-bg-soft);border:1px solid var(--border-primary);border-radius:var(--radius-lg);padding:16px;margin-bottom:12px;backdrop-filter:blur(8px)',
  sectionHeader: 'display:flex;align-items:center;justify-content:space-between;margin-bottom:8px',
  sectionTitle: 'font-size:14px;font-weight:600;color:var(--text-primary)',
  sectionScore: 'font-size:13px;font-weight:600',
  sectionDesc: 'font-size:13px;color:var(--text-secondary)',
  ...
  emptyHint: 'font-size:12px;color:var(--text-tertiary)',
}
    ...
    setup() { return () => h('div', { style: S.wrapper }, [
      ...
      h('div', { style: S.cards }, [
        ...
        h('div', { style: S.card }, [
          ...
          h('div', { style: S.cardValue + ';color:var(--text-primary);font-size:20px' }, '28.4s'),
