...
const S = {
  ...
  resultItem: 'background:var(--glass-bg-soft);border:1px solid var(--border-primary);border-radius:var(--radius-lg);padding:var(--space-3_5) var(--space-4);margin-bottom:var(--space-2);backdrop-filter:blur(8px)',
  resultHeader: 'display:flex;align-items:center;justify-content:space-between;margin-bottom:var(--space-1_5)',
  resultTitle: 'font-size:var(--text-sm);font-weight:600;color:var(--text-primary)',
  resultScore: 'font-size:var(--text-meta);font-weight:600',
  resultCategory: 'font-size:var(--text-xs);color:var(--text-tertiary);text-transform:uppercase;letter-spacing:0.5px',
  resultMeta: 'display:flex;gap:var(--space-3);margin-top:var(--space-1_5)',
  resultMetaItem: 'font-size:var(--text-xs);color:var(--text-tertiary)',
  ...
  emptyTitle: 'font-size:var(--text-base);font-weight:600;color:var(--text-primary);margin-bottom:var(--space-2)',
  emptyDesc: 'font-size:var(--text-meta);color:var(--text-secondary);line-height:1.5',
}
    ...
    setup() { return () => h('div', { style: S.wrapper }, [
      ...
      h('div', { style: S.cards }, [
        ...
        h('div', { style: S.card }, [
          ...
          h('div', { style: S.cardValue + ';color:var(--text-primary);font-size:var(--text-base)' }, 'Groq'),
