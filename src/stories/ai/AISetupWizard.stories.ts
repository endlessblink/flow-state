...
const S = {
  ...
  closeBtn: 'position:absolute;top:12px;right:12px;background:none;border:none;color:var(--text-tertiary);font-size:16px;cursor:pointer',
  ...
  badge: 'position:absolute;top:8px;right:8px;padding:2px 8px;background:var(--brand-primary);color:var(--bg-primary);border-radius:var(--radius-sm);font-size:10px;font-weight:600',
  ...
  render: () => ({
    setup() { return () => h('div', { style: S.overlay }, [
      h('div', { style: S.modal }, [
        ...
        h('a', { style: S.link }, '🔗 Get your free Groq API key →'),
