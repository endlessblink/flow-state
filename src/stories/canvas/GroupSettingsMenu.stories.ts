...
const S = {
  ...
  statusBadge: 'font-size:var(--text-xs); padding:var(--space-0_5) var(--space-2); background:var(--glass-bg-soft); color:var(--text-secondary); border:1px solid var(--glass-border); border-radius:var(--radius-full);',
  ...
  selectIconOpen: 'flex-shrink:0; color:var(--brand-primary); transform:rotate(180deg); transition:transform 150ms ease;',
  // Dropdown panel — purple-tinted glass with blur (matches real CustomSelect)
  selectWrapper: 'position:relative;',
  dropdown: 'position:absolute; top:calc(100% + 4px); left:0; right:0; z-index:9999; background:var(--glass-bg-heavy); backdrop-filter:blur(16px); -webkit-backdrop-filter:blur(16px); border:1px solid var(--glass-border); box-shadow:0 var(--space-2) var(--space-8) var(--overlay-bg),0 0 0 1px var(--glass-bg-light) inset; border-radius:var(--radius-md); max-height:200px; overflow-y:auto; padding:var(--space-1); list-style:none; margin:0;',
