...
const S = {
  ...
  sectionAccent: 'width: 3px; height: 14px; border-radius: 2px; flex-shrink: 0;',
  ...
  dueBadgeOverdue: 'font-size: 0.65rem; color: var(--color-danger); white-space: nowrap; padding: 1px var(--space-1); background: rgba(255, 107, 107, 0.08); border-radius: var(--radius-sm);',
