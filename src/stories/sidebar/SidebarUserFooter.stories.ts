...
const S = {
  ...
  loginBtn: 'width: 100%; padding: var(--space-2_5); background: var(--glass-bg-soft); color: var(--brand-primary); border: 1px solid rgba(78, 205, 196, 0.4); border-radius: var(--radius-md); cursor: pointer; display: flex; align-items: center; justify-content: center; font-weight: 600; font-size: var(--text-sm);',
  profileRow: 'display: flex; align-items: center; gap: var(--space-2_5); padding: var(--space-1);',
  avatar: 'width: 32px; height: 32px; background: var(--brand-primary); border-radius: 50%; display: flex; align-items: center; justify-content: center; color: white; font-weight: bold; font-size: var(--text-sm); flex-shrink: 0;',
