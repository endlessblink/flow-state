...
BEGIN
  -- pg_timezone_names is an expensive system view. Materialize it once per
  -- command instead of rescanning it for every recurrence occurrence while
  -- building overlap evidence.
