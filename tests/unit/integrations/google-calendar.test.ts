...
vi.mock("@/stores/settings", () => ({
  useSettingsStore: () => ({
    get googleConnected() {
      return mockGoogleConnected;
    },
    get googleProviderToken() {
      return mockGoogleToken;
    },
    get googleProviderRefreshToken() {
      return mockGoogleRefreshToken;
    },
    get googleProviderTokenExpiry() {
      return mockGoogleTokenExpiry;
    },
    get googleCalendars() {
      return mockGoogleCalendars;
    },
    get showGoogleCalendarEvents() {
      return mockShowGoogleCalendarEvents;
    },
    get externalCalendarSyncInterval() {
      return mockSyncInterval;
    },
    updateSetting: vi.fn((key: string, value: unknown) => {
      ...
      if (key === "googleProviderRefreshToken")
        mockGoogleRefreshToken = value as string;
      if (key === "googleProviderTokenExpiry")
        mockGoogleTokenExpiry = value as number;
      if (key === "googleCalendars")
        mockGoogleCalendars = value as typeof mockGoogleCalendars;
      if (key === "showGoogleCalendarEvents")
        mockShowGoogleCalendarEvents = value as boolean;
    }),
  }),
}));
